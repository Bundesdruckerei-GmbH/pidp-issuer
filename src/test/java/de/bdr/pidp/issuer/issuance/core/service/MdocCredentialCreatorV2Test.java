...
class MdocCredentialCreatorV2Test extends MdocCredentialCreatorTestBase {
    ...
    private static final Period MAX_VALIDITY = ISSUANCE_CONFIG.getMaxValidity();

    private static MdocCredentialCreatorV2 subject;
    ...
    static void setUp() throws UnrecoverableKeyException, CertificateException, IOException, KeyStoreException, NoSuchAlgorithmException {
        var mdocMetadata = (CredentialConfiguration.Mdoc) ISSUANCE_METADATA.credentialConfigurationsSupported().get(CredentialConfigurationID.MSO_MDOC_V2);
        var signer = new PKCS12CredentialSigner(ISSUANCE_CONFIG);
        subject = new MdocCredentialCreatorV2(signer, MAX_VALIDITY, mdocMetadata.doctype());
    ...
    class MdocNamespacesTest {
        ...
        @DisplayName("Verify mdoc V2 contained all eu claims")
        @Test
        void test001() {
            // Given
            var statusRef = getStatusReference();
            ...
            assertSoftly(soft -> {
                soft.assertThat(pidValues)
                    ...
                    .isNotNull()
                    .extracting(i -> LocalDate.parse((String) i, DateTimeFormatter.ISO_LOCAL_DATE))
                    .isEqualTo(LocalDate.ofInstant(TODAY, LOCAL_ZONE).plus(MAX_VALIDITY));
                soft.assertThat(pidValues).hasSize(13);
        ...
        @DisplayName("Verify mdoc V2 contained all de claims")
        @Test
        void test002() {
            // Given
            var statusRef = getStatusReference();
            ...
            assertSoftly(soft -> {
                ...
                soft.assertThat(pidValues).extractingByKey("place_of_birth").asInstanceOf(map(String.class, Boolean.class))
                    .hasSize(1).containsEntry("no_place_info", false);
        ...
        @DisplayName("Verify mdoc V2 built eu pid namespace correct with minimal data")
        @Test
        void test003() {
            // Given
            var statusRef = getStatusReference();
        ...
        @DisplayName("Verify mdoc V2 built de pid namespace correct with minimal data")
        @Test
        void test004() {
            // Given
            var statusRef = getStatusReference();
            ...
            assertSoftly(soft -> {
                ...
                soft.assertThat(pidValues).extractingByKey("source_document_type").isEqualTo("ID");
                soft.assertThat(pidValues).extractingByKey("place_of_birth").asInstanceOf(map(String.class, Boolean.class))
                    .hasSize(1).containsEntry("no_place_info", true);
        ...
        @DisplayName("Verify expiry_date where encoded as 'full-date = #6.1004(tstr)'")
        @Test
        void test008() {
            // Given
            var statusRef = getStatusReference();
            ...
            assertThat(nameSpaceDataElementStream)
                ...
                .noneMatch(o -> o.getElementIdentifier().equals("issuance_date"));
        }

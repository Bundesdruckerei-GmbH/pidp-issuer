...
@Validated
public class MdocCredentialCreatorV1 implements CredentialCreator {
    ...
    public MdocCredentialCreatorV1(@NotNull CredentialSigner signer, String docType) {
        this.signer = signer;
    ...
    public String create(PIDIdentityData data, JWK holderBindingKey, StatusReference status, Validity validity) {
        ...
        var pidNamespace = new MdocPIDNamespaceBuilderV1(EU_NAMESPACE)
            .personalData(data)
